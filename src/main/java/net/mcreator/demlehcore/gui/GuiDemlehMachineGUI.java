...
import net.mcreator.demlehcore.procedure.ProcedureDemlehMachineProcedure;
...
public class GuiDemlehMachineGUI extends ElementsDemlehcoreMod.ModElement {
	public static int GUIID = 2;
	public static HashMap guistate = new HashMap();
	public GuiDemlehMachineGUI(ElementsDemlehcoreMod instance) {
		super(instance, 138);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.customSlots.put(0, this.addSlotToContainer(new Slot(internal, 0, 7, 12) {
			}));
			this.customSlots.put(1, this.addSlotToContainer(new Slot(internal, 1, 7, 48) {
			}));
			this.customSlots.put(2, this.addSlotToContainer(new Slot(internal, 2, 43, 30) {
			}));
			this.customSlots.put(3, this.addSlotToContainer(new Slot(internal, 3, 142, 30) {
				@Override
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("demlehcore:textures/demleh_machine_gui.png");
		@Override
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("Demleh Machine", 51, 7, -10027264);
		}
		...
		public void initGui() {
			...
			this.buttonList.add(new GuiButton(0, this.guiLeft + 60, this.guiTop + 56, 60, 20, "Craft!"));
		}
		...
		if (buttonID == 0) {
			{
				...
				ProcedureDemlehMachineProcedure.executeProcedure($_dependencies);
			}
		}
	}
