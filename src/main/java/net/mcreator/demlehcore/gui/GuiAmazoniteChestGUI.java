...
public class GuiAmazoniteChestGUI extends ElementsDemlehcoreMod.ModElement {
	public static int GUIID = 5;
	public static HashMap guistate = new HashMap();
	public GuiAmazoniteChestGUI(ElementsDemlehcoreMod instance) {
		super(instance, 200);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.y = y;
			this.z = z;
			this.internal = new InventoryBasic("", true, 63);
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("demlehcore:textures/amazonite_chest_gui.png");
		@Override
