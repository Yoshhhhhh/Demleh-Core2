...
public class ItemEboniteCollectorStick extends ElementsDemlehcoreMod.ModElement {
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("demlehcore:ebonite_collector_stick", "inventory"));
	}
