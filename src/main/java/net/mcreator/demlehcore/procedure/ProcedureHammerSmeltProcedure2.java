...
public class ProcedureHammerSmeltProcedure2 extends ElementsDemlehcoreMod.ModElement {
	public ProcedureHammerSmeltProcedure2(ElementsDemlehcoreMod instance) {
		super(instance, 175);
	}

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure HammerSmeltProcedure2!");
			return;
		}
		if (dependencies.get("x") == null) {
			System.err.println("Failed to load dependency x for procedure HammerSmeltProcedure2!");
			return;
		}
		if (dependencies.get("y") == null) {
			System.err.println("Failed to load dependency y for procedure HammerSmeltProcedure2!");
			return;
		}
		if (dependencies.get("z") == null) {
			System.err.println("Failed to load dependency z for procedure HammerSmeltProcedure2!");
			return;
		}
		if (dependencies.get("world") == null) {
			System.err.println("Failed to load dependency world for procedure HammerSmeltProcedure2!");
			return;
		}
		...
		if (((new ItemStack(ItemEboniteSmeltHammer.block, (int) (1)).getItem()
